...
public class PrivatizerMod
{
    ...
    public static PacketManager packetManager = new PacketManager("fr.mcnanotech.privatizer.common.packet", MODID, MODID);
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        privateEditor = new BlockPermissionEditor(Material.iron).setBlockName("permissionEditor").setResistance(5000F).setHardness(10F).setCreativeTab(privatizerTab);

        GameRegistry.registerBlock(privateBlock, ItemBlockPrivate.class, "block_private");
        GameRegistry.registerBlock(privateChest, ItemBlockPrivateChest.class, "block_private_chest");
        GameRegistry.registerBlock(privateDoor, ItemBlockPrivateDoor.class, "block_private_door");
        GameRegistry.registerBlock(privateEditor, "block_permission_editor");
