...
public class TileEntityPasswordChestRenderer extends TileEntityInventorySpecialRenderer
{
    private final ResourceLocation texture = new ResourceLocation("privatizer", "textures/models/blocks/password_chest.png");
    private final ModelPrivateChest model = new ModelPrivateChest();
    
    @Override
    public void renderInventory(double x, double y, double z)
    {
        this.renderPasswordChestAt(null, x, y, z, 0);
    }

    @Override
    public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float tick)
    {
        this.renderPasswordChestAt((TileEntityPasswordChest)tile, x, y, z, tick);
    }
    
    public void renderPasswordChestAt(TileEntityPasswordChest chest, double x, double y, double z, float tick)
    {
        GL11.glPushMatrix();
